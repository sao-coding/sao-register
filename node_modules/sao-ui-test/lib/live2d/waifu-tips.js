...
const LAppDefine ={
    MODELS: [
        [
            "model/Asuna/asuna_01/index.json",
            "model/Asuna/asuna_02/index.json",
            "model/Asuna/asuna_03/index.json",
            "model/Asuna/asuna_04/index.json",
            "model/Asuna/asuna_05/index.json",
            "model/Asuna/asuna_06/index.json",
            "model/Asuna/asuna_07/index.json",
            "model/Asuna/asuna_08/index.json",
            "model/Asuna/asuna_09/index.json",
            "model/Asuna/asuna_12/index.json",
        ],
    ]
}
...
export function initModel(waifuPath, type) {
    ...
    else if (live2d_settings.waifuEdgeSide[0] == 'leftPercent') $(".waifu").css("left",live2d_settings.waifuEdgeSide[1]+'%');
...
function loadModel(modelId, modelTexturesId=0) {
    ...
    //新版本加载本地的模型资源
    loadlive2d("live2d",live2d_settings.modelAPI+LAppDefine.MODELS[modelId-1][modelTexturesId-1],(live2d_settings.showF12Status ? console.log('[Status]','live2d','模型',modelId+'-'+modelTexturesId,'加载完成'):null));
}
